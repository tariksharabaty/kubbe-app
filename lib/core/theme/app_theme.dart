...
class AppTheme {
  ...
  // TR: Counter Text Theme - Sayılar ve sayaçlar için
  // EN: Counter Text Theme - For numbers and counters
  static TextTheme get counterTextTheme => KubbeTheme._counterTextTheme;
}
...
class KubbeTheme {
  ...
  // TR: Ana Renkler - KubbeIndigo ve M3 Surface palette
  // EN: Primary Colors - KubbeIndigo and M3 Surface palette
  static const Color kubbeIndigo = Color(0xFF4B0082);
  static const Color syOsBackground = Color(0xFFF8F9FA); // M3 Surface
  static const Color syOsSurface = Color(0xFFFFFBFE); // M3 Surface variant
  static const Color syOsSurfaceVariant =
      Color(0xFFF3E5F5); // M3 Surface container
  static const Color syOsAccent = Color(0xFF9C27B0);
  static const Color syOsError = Color(0xFFF44336);
  static const Color textPrimary = Color(0xFF1A1A1A);
  static const Color textSecondary = Color(0xFF666666);
  ...
  // TR: Başlık Metin Stilleri - 'Outfit' (w900/Black) fontunu kullanır
  // EN: Headline Text Styles - Uses 'Outfit' (w900/Black) font
  static TextTheme get _headlineTextTheme {
    ...
    return TextTheme(
      ...
      titleSmall: outfitTextStyle.copyWith(
          fontSize: 14, fontWeight: FontWeight.w800, height: 1.4),
    );
  }

  // TR: Sayı ve Sayaç Metin Stilleri - 'Poppins' (Bold) fontunu kullanır
  // EN: Number and Counter Text Styles - Uses 'Poppins' (Bold) font
  static TextTheme get _counterTextTheme {
    final poppinsTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.bold,
      color: textPrimary,
    );
    return TextTheme(
      displayLarge: poppinsTextStyle.copyWith(fontSize: 57, height: 1.2),
      displayMedium: poppinsTextStyle.copyWith(fontSize: 45, height: 1.2),
      displaySmall: poppinsTextStyle.copyWith(fontSize: 36, height: 1.2),
      headlineLarge: poppinsTextStyle.copyWith(fontSize: 32, height: 1.3),
      headlineMedium: poppinsTextStyle.copyWith(fontSize: 28, height: 1.3),
      headlineSmall: poppinsTextStyle.copyWith(fontSize: 24, height: 1.3),
      titleLarge: poppinsTextStyle.copyWith(fontSize: 22, height: 1.4),
      titleMedium: poppinsTextStyle.copyWith(
      ...
      bodyLarge: poppinsTextStyle.copyWith(fontSize: 16, height: 1.5),
      bodyMedium: poppinsTextStyle.copyWith(fontSize: 14, height: 1.5),
      bodySmall: poppinsTextStyle.copyWith(fontSize: 12, height: 1.5),
    );
  }
  ...
  static ThemeData get lightTheme {
    final baseTheme = ThemeData.from(
      colorScheme: ColorScheme.fromSeed(
        ...
        surface: syOsSurface,
        surfaceContainer: syOsSurfaceVariant,
        error: syOsError,
  ...
  static ThemeData get darkTheme {
    final darkColorScheme = ColorScheme.fromSeed(
      ...
      primary: kubbeIndigo,
      secondary: syOsAccent,
      surface: const Color(0xFF0D1117), // M3 Dark Surface
      surfaceContainer: const Color(0xFF1A1A1A), // M3 Dark Surface container
      error: syOsError,
      onPrimary: textOnPrimary,
      onSecondary: textOnPrimary,
  ...
  static ThemeData get amberTheme {
    final amberColorScheme = ColorScheme.fromSeed(
      ...
      surface: const Color(0xFF1A1A1A), // M3 Dark Surface
      surfaceContainer: const Color(0xFF2D2D2D), // M3 Dark Surface container
      error: syOsError,
