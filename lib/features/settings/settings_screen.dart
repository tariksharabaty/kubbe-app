      ...
      child: GestureDetector(
        onTap: () {
          ...
          if (themeMode == ThemeMode.system) {
            ...
            // TR: Normal tema (Light/Dark)
            // EN: Normal theme (Light/Dark)
            prefsManager.setThemeMode(themeMode);
            // TR: Amber modunu kapat
            // EN: Turn off amber mode
            prefsManager.setAmberMode(false);
          }
        },
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                // TR: Verileri sıfırla
                // EN: Reset data
                await prefsManager.setThemeMode(ThemeMode.system);
                await prefsManager.setAmberMode(false);
